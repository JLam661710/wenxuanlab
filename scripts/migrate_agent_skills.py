...
SOURCE_ROOT = "/Users/lishuyi/Downloads/文玄 Lab/BBB 内容素材与结构索引/【4】智能体范式下的工具开发——Agent`s Skills（智能体技能）"
TARGET_ROOT = "/Users/lishuyi/Downloads/文玄 Lab/文玄_Lab_Web/agent-skills"
...
def migrate():
    ...
    for item in root_items:
        ...
        if os.path.isdir(abs_path):
            group = get_sidebar_item(abs_path, f"/agent-skills/{item}")
            if group:
