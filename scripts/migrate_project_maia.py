...
SOURCE_ROOT = "/Users/lishuyi/Downloads/文玄 Lab/BBB 内容素材与结构索引/【2】智能体应用程序产品开发——Project Maia（多智能体驱动的 AI 产品战略访谈局）"
TARGET_ROOT = "/Users/lishuyi/Downloads/文玄 Lab/文玄_Lab_Web/project-maia"
...
def migrate():
    ...
    for item in root_items:
        ...
        if os.path.isdir(abs_path):
            group = get_sidebar_item(abs_path, f"/project-maia/{item}")
            if group:
